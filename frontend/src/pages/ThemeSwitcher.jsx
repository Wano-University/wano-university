...
const THEMES = [
  { id: 'light', label: 'Default', mode: 'Light', p: { bg: 'oklch(0.9564 0.0094 279.69)', card: 'oklch(0.9886 0.0026 286.35)', primary: 'oklch(0.3093 0.2115 264.10)', muted: 'oklch(0.9309 0.0134 286.14)', border: 'oklch(0.8695 0.0357 287.40)' } },
  { id: 'dark', label: 'Default', mode: 'Dark', p: { bg: 'oklch(0.2288 0.0505 275.09)', card: 'oklch(0.2314 0.0488 273.47)', primary: 'oklch(0.8907 0.0339 259.42)', muted: 'oklch(0.2799 0.0722 272.24)', border: 'oklch(0.3633 0.0980 269.71)' } },
  { id: 'pink', label: 'Pink', mode: 'Light', p: { bg: 'oklch(0.9564 0.0094 279.69)', card: 'oklch(0.9886 0.0026 286.35)', primary: 'oklch(0.65 0.22 350)', muted: 'oklch(0.9309 0.0134 286.14)', border: 'oklch(0.8695 0.0357 287.40)' } },
  { id: 'darkPink', label: 'Pink', mode: 'Dark', p: { bg: 'oklch(0.2288 0.0505 275.09)', card: 'oklch(0.2314 0.0488 273.47)', primary: 'oklch(0.75 0.12 350)', muted: 'oklch(0.2799 0.0722 272.24)', border: 'oklch(0.3633 0.0980 269.71)' } },
  { id: 'teal', label: 'Teal', mode: 'Light', p: { bg: 'oklch(0.96 0.01 190)', card: 'oklch(0.98 0.005 190)', primary: 'oklch(0.60 0.18 185)', muted: 'oklch(0.92 0.02 190)', border: 'oklch(0.85 0.03 190)' } },
  { id: 'darkTeal', label: 'Teal', mode: 'Dark', p: { bg: 'oklch(0.20 0.04 190)', card: 'oklch(0.22 0.04 190)', primary: 'oklch(0.75 0.12 185)', muted: 'oklch(0.28 0.04 190)', border: 'oklch(0.35 0.05 190)' } },
  { id: 'blackAndWhite', label: 'Black & White', mode: 'Light', p: { bg: 'oklch(0.98 0 0)', card: 'oklch(0.95 0 0)', primary: 'oklch(0.1 0 0)', muted: 'oklch(0.9 0 0)', border: 'oklch(0.8 0 0)' } },
  { id: 'darkBlackAndWhite', label: 'Black & White', mode: 'Dark', p: { bg: 'oklch(0.1 0 0)', card: 'oklch(0.15 0 0)', primary: 'oklch(0.95 0 0)', muted: 'oklch(0.2 0 0)', border: 'oklch(0.25 0 0)' } },
  { id: 'bluee', label: 'Blue', mode: 'Light', p: { bg: 'oklch(0.96 0.01 240)', card: 'oklch(0.98 0.005 240)', primary: 'oklch(0.55 0.20 240)', muted: 'oklch(0.92 0.02 240)', border: 'oklch(0.85 0.03 240)' } },
  { id: 'darkBluee', label: 'Blue', mode: 'Dark', p: { bg: 'oklch(0.15 0.04 240)', card: 'oklch(0.18 0.04 240)', primary: 'oklch(0.70 0.12 240)', muted: 'oklch(0.25 0.04 240)', border: 'oklch(0.30 0.05 240)' } },
  { id: 'red', label: 'Red', mode: 'Light', p: { bg: 'oklch(0.97 0.005 20)', card: 'oklch(0.99 0.002 20)', primary: 'oklch(0.50 0.12 20)', muted: 'oklch(0.92 0.01 20)', border: 'oklch(0.85 0.02 20)' } },
  { id: 'darkRed', label: 'Red', mode: 'Dark', p: { bg: 'oklch(0.15 0.02 20)', card: 'oklch(0.18 0.02 20)', primary: 'oklch(0.65 0.10 20)', muted: 'oklch(0.22 0.02 20)', border: 'oklch(0.25 0.03 20)' } },
  { id: 'wine', label: 'Wine', mode: 'Light', p: { bg: 'oklch(0.97 0.005 20)', card: 'oklch(0.99 0.002 20)', primary: 'oklch(0.40 0.15 350)', muted: 'oklch(0.92 0.01 20)', border: 'oklch(0.85 0.02 20)' } },
  { id: 'darkWine', label: 'Wine', mode: 'Dark', p: { bg: 'oklch(0.15 0.02 20)', card: 'oklch(0.18 0.02 20)', primary: 'oklch(0.60 0.20 350)', muted: 'oklch(0.22 0.02 20)', border: 'oklch(0.25 0.03 20)' } },
];
