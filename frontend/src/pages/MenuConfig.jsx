            ...
            <div className="overflow-y-auto space-y-2 pr-1 flex-1">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h5 className="text-sm font-bold truncate transition-colors">Clear Selection</h5>
                  <p className="text-xs truncate">Leave {editingDay} unassigned</p>
                </div>
              </div>
    ...
    <div className="bg-card text-card-foreground w-full max-w-lg p-6 rounded-3xl shadow-2xl border border-border flex flex-col relative font-sans max-h-[90vh] overflow-y-auto z-50">
      <div className="mb-6 flex justify-between items-start">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Expand or update the unified {activeTab} inventory pool.</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1.5">
          <label className="text-xs font-bold text-primary flex items-center gap-1.5">
            <Type className="w-3.5 h-3.5" /> Dish title:
          </label>
        ...
        <div className="flex items-center justify-between p-3 bg-muted/30 border border-border rounded-xl mt-2">
          <div className="flex flex-col">
            <span className="text-sm font-bold tracking-tight">Active availability</span>
          </div>
